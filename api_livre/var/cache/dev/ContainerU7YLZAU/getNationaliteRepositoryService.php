...
// Returns the private 'App\Repository\NationaliteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NationaliteRepository.php';

return $this->privates['App\\Repository\\NationaliteRepository'] = new \App\Repository\NationaliteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
